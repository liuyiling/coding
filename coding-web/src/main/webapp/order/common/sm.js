...
+ function($) {
    ...
    var Picker = function (params) {
        ...
        p.layout = function () {
            ...
            var pickerClass = '';
            var i;
            var keyBarTpl = '<div class="key-bar">{bars}</div>';
            var bars = '';
            p.cols = [];
            var colsHTML = '';
            for (i = 0; i < p.params.cols.length; i++) {
                ...
                p.cols.push(col);
                if(p.params.keyBar){
                    bars += '<div class="key">' + col.key + '</div>';
                }
            }
            pickerClass = 'picker-modal picker-columns ' + (p.params.cssClass || '') + (p.params.rotateEffect ? ' picker-3d' : '');
            pickerHTML =
                '<div class="' + (pickerClass) + '">' +
                (p.params.toolbar ? substitute(p.params.toolbarTemplate, {closeText:p.params.closeText, title: p.params.title}) : '') +
                (p.params.keyBar ? substitute(keyBarTpl, {bars: bars}) : '') +
            ...
            // pickerHTML = pickerHTML + '<div style="color:red;font-size:66px;position:fixed;top:0;">222</div>'
        ...
        p._mask = $('<div class="picker-panel-mask"></div>');
        p._body = $('body');
        p._body.append(p._mask);
